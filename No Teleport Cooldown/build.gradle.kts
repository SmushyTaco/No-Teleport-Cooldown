...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(483955, jar)
        file.displayName = "[${libs.versions.minecraft.get()}] No Teleport Cooldown"
...
modrinth {
    ...
    projectId = "no-teleport-cooldown"
    uploadFile.set(tasks.jar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] No Teleport Cooldown" }
    dependencies {
